...
async function init() {
  ...
  // There is no Search button - the fields below search as you change them.
  // Enter is still handled because browsers that do implicit submission on a
  // buttonless form would otherwise reload the page.
